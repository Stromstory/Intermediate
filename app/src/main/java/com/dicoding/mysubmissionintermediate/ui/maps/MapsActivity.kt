...
import com.dicoding.mysubmissionintermediate.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val factory: FactoryViewModel = FactoryViewModel.getInstance(this)
                    ...
                    story.data.forEach { item ->
                        ...
                        mMap.addMarker(
                            MarkerOptions()
                                ...
                                .icon(BitmapDescriptorFactory.fromBitmap(vectorToBitmap(R.drawable.ic_auto_stories_24)))
                        )
